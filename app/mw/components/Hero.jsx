...
import hero from '@/public/thinking.svg'
        ...
        <div className='items-center lg:flex mt-24 md:mt-40'>
            <div className='w-full lg:w-1/2'>
                <div className='lg:max-w-lg'>
                    <h3 className='text-center md:text-left text-xl sm:text-4xl font-bold text-gray-800 lg:text-2xl'>SUPAMOTO MALAWI</h3>
                    <h1 className='text-center md:text-left text-3xl sm:text-6xl font-bold text-gray-800 lg:text-4xl'>Renewable Clean Energy<br/> For All <span className='text-orange-500 '>Zambians</span></h1>
            ...
            <div className='flex items-center justify-center w-full mt-6 lg:mt-0 lg:w-1/2'>
                <Image src={hero} width={800} height={400} alt='Logo' />
            </div>
        </div>
    </div>
  )
