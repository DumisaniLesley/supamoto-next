...
import hero from '@/public/business.svg'
        ...
        <div className='items-center lg:flex mt-24 md:mt-40'>
            <div className='w-full lg:w-1/2'>
                <div className='lg:max-w-lg'>
                    <h1 className='text-center md:text-left text-3xl sm:text-6xl font-bold text-gray-800 lg:text-4xl'>Renewable Clean Energy<br/> For All <span className='text-orange-600 '>Malawians</span></h1>
