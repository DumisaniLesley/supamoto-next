        ...
        <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3 text-center md:text-left">
            <div>
                <div className='flex items-center justify-center'>
                    <svg className=" w-20 h-20" viewBox="0 0 30 30" fill="none">
                ...
                <h1 className="mt-4 text-xl font-bold">Default Taiwindcss Config</h1>
            ...
            <div>
                ...
                <h1 className="mt-4 text-xl font-bold text-gray-800 ">Fully Responsive Components</h1>
                <p className="mt-2 text-gray-500 dark:text-gray-400">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Dignissim fusce tortor, ac sed malesuada blandit. Et mi gravida sem feugiat.</p>
            </div>
            <div>
                <div className='flex items-center justify-center'>
                ...
                <h1 className="mt-4 text-xl font-bold text-gray-800 ">RTL Languages Support</h1>
                <p className="mt-2 text-gray-500 dark:text-gray-400">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Dignissim fusce tortor, ac sed malesuada blandit. Et mi gravida sem feugiat.</p>
            </div>
        </div>
    </div>
