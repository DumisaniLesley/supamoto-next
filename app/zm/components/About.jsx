        ...
        <div className='mt-8 lg:-mx-6 lg:flex lg:items-center'>
            ...
            <div className='mt-6 lg:w-1/2 lg:mt-0 lg:mx-6 tracking-wide px-4'>
                ...
                <div className='flex justify-center items-center md:justify-start mt-8 md:mt-4'>
                    <Link href='/zm/about' className='text-center w-full px-5 py-4 text-md font-semibold tracking-wider text-white uppercase transition-colors duration-300 transform bg-orange-600 rounded-md lg:w-auto hover:bg-blue-500'>More About Us</Link>
                </div>
            </div>
        </div>
    </div>
