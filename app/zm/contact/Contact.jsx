...
const Contact = () => {
  return (
    ...
    <div className="container max-w-6xl px-6 py-16 mx-auto">
        <div className="lg:flex lg:items-center lg:-mx-6 mt-20">
            ...
            <div className="mt-8 lg:w-1/2 lg:mx-6">
                <div
                    className="w-full px-8 py-8 mx-auto overflow-hidden bg-white rounded-lg shadow-2xl lg:max-w-xl shadow-gray-300/50 ">
